export class AddCardButton {
  constructor(
    score,
    onAddCard,
    savedAddCardPrice = 100,
    savedPriceIncrease = 100
  ) {
  ...
  createButton() {
    ...
    button.className =
      'fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed'
    button.innerHTML = `
